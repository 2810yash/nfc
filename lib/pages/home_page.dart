...
import 'package:nfc/pages/userdetails.dart';
import 'package:nfc/services/ocr.dart';
      ...
      return Container(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            backgroundColor: Colors.purple[400], // #FFA3FD
            actions: [
              IconButton(
                ...
                child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: BottomBarItem(Icons.download, "", isActive: activeTab == 3, activeColor: primary),
                      ),
                      GestureDetector(
                        onTap: () {
                          setState(() {
